...
class Coches:
    ...
    def __init__(self,color,marca,modelo,velocidad,caballaje,plazas):
        ...
        self.plazas=plazas
    #El encapsulamiento o visibilidad es importante que a traves de el es 
    #posible que python sepa coma va a utilizar y manipular los atributos y metodos de clase 
    ...
    #Nota 1. para utilizar un atributo privado 
